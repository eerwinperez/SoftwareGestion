 ...
 * @author erwin
 */
public class SeleccionClienteParaRemitir extends javax.swing.JFrame {
     ...
     */
    public SeleccionClienteParaRemitir() {
        initComponents();
    ...
    public SeleccionClienteParaRemitir(String usuario, String permiso) {
        initComponents();
    ...
    public void ConfiguracionGralJFrame() {
        ...
        //Titulo
        setTitle("Seleccion de cliente para generar remito*** " + "Usuario: " + usuario + " - " + permiso);
    ...
    private void jButton_cargarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_cargarVentaActionPerformed
        ...
        if (!nombreCliente.equals("")) {
            ...
            new ListadoRemitir(usuario, permiso, nombreCliente).setVisible(true);
            dispose();
        } else {
            if (!cedulaNIT.equals("")) {
                ...
                if (!Cliente.equals("")) {
                    ...
                    new ListadoRemitir(usuario, permiso, Cliente).setVisible(true);
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionClienteParaRemitir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionClienteParaRemitir().setVisible(true);
            }
        });
    }
